...
#     """Menerapkan filter sharpening menggunakan metode Unsharp Masking."""
...
# def enhance_contrast_frame(frame):
...
def main(_argv):
    ...
    while True:
        ...
        if return_value:
            # denoise and enhance frame
            frame = denoise_frame(frame)
            
            # blur and sharpen frame
            # frame = sharpen_frame(frame)

            # # enhance contrast of frame
            # frame = enhance_contrast_frame(frame)
